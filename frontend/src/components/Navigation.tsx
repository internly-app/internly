              ...
              <>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button 
                      className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted hover:bg-muted/70 data-[state=open]:bg-muted/70 transition-colors duration-200 cursor-pointer outline-none focus:outline-none"
