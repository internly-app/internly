    ...
    return (
      <>
        <Card
          ...
          aria-label={`Review of ${review.role.title} at ${
            review.company.name
          ...
          <CardHeader className="p-4 sm:p-6 pb-3 sm:pb-3 flex-shrink-0">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <button
                  ...
                  aria-label={
                    likeData.hasLiked
                      ? `Unlike this review (${likeData.likeCount} likes)`
                      : `Like this review (${likeData.likeCount} likes)`
                  }
            ...
            <div className="flex flex-wrap items-center gap-1.5 mt-3 overflow-hidden">
              {review.work_style && (
                ...
                >
                  {review.work_style.charAt(0).toUpperCase() +
          ...
          {isExpanded && (
            <CardContent className="p-4 sm:p-6 pt-0 sm:pt-0 pb-4 space-y-4">
              ...
              <div className="space-y-2">
                <Badge
                  variant="outline"
                  className="bg-yellow-50 dark:bg-yellow-950 text-yellow-800 dark:text-yellow-200 border-yellow-200 dark:border-yellow-800 text-xs"
                >
                  ✨ Overall Experience
                </Badge>
                <p className="text-sm text-muted-foreground leading-relaxed whitespace-pre-wrap">
                  {stripHTML(
                    ("overall_experience" in review && review.overall_experience
                      ? review.overall_experience
                      : review.best || review.hardest) as string
                  )}
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-1 text-sm text-muted-foreground">
                  <p>
                    ${review.wage_hourly?.toFixed(2) || "0.00"}/hr{" "}
                    {review.wage_currency || "CAD"}
                  </p>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Badge
              variant="outline"
              className="bg-yellow-50 dark:bg-yellow-950 text-yellow-800 dark:text-yellow-200 border-yellow-200 dark:border-yellow-800"
            >
              ✨ Overall Experience
            </Badge>
            <p className="text-sm text-muted-foreground leading-relaxed whitespace-pre-wrap">
        ...
        <CardFooter className="flex items-center justify-between pt-6">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="text-sm font-medium ml-4" aria-hidden="true">
                {likeData.likeCount}
              </span>
            </Button>
          </div>
